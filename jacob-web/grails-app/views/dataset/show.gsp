...
<html>
    ...
    <body>
        ...
        <div id="show-dataset" class="content scaffold-show" role="main">
            ...
            <f:display bean="dataset" />
            <g:form resource="${this.dataset}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dataset}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
